            ...
            <div class="col-lg-4">
                <div class="summary-card">
                    ...
                    <div class="summary-actions">
                        <!-- ✅ FIXED: Place Order now links directly to checkout.php -->
                        <a href="checkout.php" class="btn-checkout">
                            <i class="fas fa-bag-shopping me-2"></i>Place Order
                        </a>
                        <!-- Get Quotation still opens the quotation modal -->
                        <button class="btn-quotation" onclick="openQuotationModal()">
                            <i class="fas fa-file-invoice me-2"></i>Get Quotation
                        </button>
...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* ── Page Header ── */
    .page-header { padding: 7rem 0 3.5rem; margin-top: 4px; position: relative; overflow: hidden; background: #000; }
    ...
    /* Place Order — <a> tag linking to checkout.php */
    .btn-checkout { display: flex; align-items: center; justify-content: center; width: 100%; padding: .9rem 1.5rem; background: var(--primary); color: white; border: none; border-radius: var(--radius-md); font-family: var(--font); font-size: 1rem; font-weight: 600; cursor: pointer; transition: all .25s; margin-bottom: .75rem; letter-spacing: -.01em; text-decoration: none; }
    .btn-checkout:hover { background: var(--primary-dark); transform: translateY(-1px); box-shadow: 0 4px 16px rgba(22,196,127,0.35); color: white; }
...
document.addEventListener('keydown', e => {
    if (e.key === 'Escape') closeModal('quotationModal');
});
