...
<section class="categories-section">
    ...
    <div class="cats-grid">
        <?php
        $categories = [
            ['icon'=>'fa-laptop',    'title'=>'Laptops & Notebooks',  'desc'=>'High-performance laptops for gaming, business & everyday use.', 'url'=>'products.php?category=laptops',    'img'=>'assets/homeassets/laptop.webp',    'color'=>'#0d1b2a'],
            ['icon'=>'fa-desktop',   'title'=>'Desktop PCs',          'desc'=>'Custom-built desktops and workstations for maximum performance.','url'=>'products.php?category=desktops',   'img'=>'assets/homeassets/desktop.webp',   'color'=>'#0a1628'],
            ['icon'=>'fa-memory',    'title'=>'RAM & Storage',         'desc'=>'High-speed memory modules and storage solutions.',               'url'=>'products.php?category=memory',     'img'=>'assets/homeassets/rams.webp',     'color'=>'#0d1a0d'],
            ['icon'=>'fa-tv',        'title'=>'Graphics Cards',        'desc'=>'Latest VGA cards for gaming and professional work.',             'url'=>'products.php?category=graphics',   'img'=>'assets/homeassets/vga.webp',   'color'=>'#1a0d28'],
            ['icon'=>'fa-keyboard',  'title'=>'Keyboards & Mouse',      'desc'=>'Premium input devices for gaming and productivity.',             'url'=>'products.php?category=peripherals','img'=>'assets/homeassets/keyboard.webp','color'=>'#1a1200'],
            ['icon'=>'fa-headphones','title'=>'Audio Devices',         'desc'=>'High-quality headphones, speakers and audio equipment.',         'url'=>'products.php?category=audio',      'img'=>'assets/homeassets/audio.webp',      'color'=>'#0d1a1a'],
        ];
