...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['login'])) {
        ...
        if (!$first_name||!$last_name||!$phone||!$address||!$city||!$country||!$email||!$password||!$confirm_password) {
            $error = "Please fill in all fields.";
...
<head>
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .btn-google::before{content:'';position:absolute;inset:0;background:rgba(0,0,0,0);transition:background var(--tr)}
    ...
    .btn-google:hover::before{background:rgba(0,0,0,.015)}
    ...
    .btn-auth:hover{background:var(--accent-dark);transform:translateY(-1px);box-shadow:0 8px 24px rgba(79,70,229,.45)}
    ...
    <div class="auth-card">
        ...
        <div class="auth-body">
            ...
            <div class="auth-panel <?= $show_signup ? 'active' : '' ?>" id="panelSignup">
                ...
                <div class="or-divider">or fill in the form</div>
                ...
                <form method="POST" action="" novalidate>
                    <div class="f-row">
                        <div class="f-group">
                            ...
                            <div class="f-wrap">
                                ...
                                <input type="text" id="first_name" name="first_name" placeholder="John" value="<?= old('first_name') ?>" autocomplete="given-name" required>
                            </div>
                        </div>
                        <div class="f-group">
                            ...
                            <div class="f-wrap">
                                <i class="fas fa-user f-ico"></i>
                                <input type="text" id="last_name" name="last_name" placeholder="Doe" value="<?= old('last_name') ?>" autocomplete="family-name" required>
                            </div>
                        </div>
                    </div>
                    <div class="f-row">
                        <div class="f-group">
                            ...
                            <div class="f-wrap">
                                ...
                                <input type="tel" id="phone" name="phone" placeholder="+94 77 000 0000" value="<?= old('phone') ?>" autocomplete="tel" required>
                            </div>
                        </div>
                        <div class="f-group">
                            ...
                            <div class="f-wrap">
                                ...
                                <input type="text" id="city" name="city" placeholder="Colombo" value="<?= old('city') ?>" autocomplete="address-level2" required>
                            </div>
                        </div>
                    </div>
                    <div class="f-row">
                        <div class="f-group">
                            ...
                            <div class="f-wrap">
                                ...
                                <input type="text" id="address" name="address" placeholder="Street address" value="<?= old('address') ?>" autocomplete="street-address" required>
                            </div>
                        </div>
                        <div class="f-group">
                            ...
                            <div class="f-wrap">
                                ...
                                <input type="text" id="country" name="country" placeholder="Sri Lanka" value="<?= old('country') ?>" autocomplete="country-name" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="f-group">
                        ...
                        <div class="f-wrap">
                            <i class="fas fa-envelope f-ico"></i>
                            <input type="email" id="signup_email" name="email" placeholder="you@example.com" value="<?= old('email') ?>" autocomplete="email" required>
                        </div>
                    </div>
                    <div class="f-group">
                        ...
                        <div class="f-wrap">
                            <i class="fas fa-lock f-ico"></i>
                            <input type="password" id="signup_password" name="password" placeholder="Min. 6 characters" autocomplete="new-password" minlength="6" required class="has-eye">
                    ...
                    <div class="f-group">
                        ...
                        <div class="f-wrap">
                            ...
                            <input type="password" id="confirm_password" name="confirm_password" placeholder="Re-enter password" autocomplete="new-password" required class="has-eye">
