...
<style>
    ...
    .btn-det-quote {
        ...
        border:2px solid #0066ff; border-radius:var(--r-md); cursor:pointer;
        font-family:'Red Hat Display',sans-serif; font-size:.92rem; font-weight:700;
    ...
    .det-no-desc {
        ...
        background:var(--surface); border:1px dashed rgba(0,0,0,.1);
        border-radius:var(--r-lg); max-width:480px; margin:0 auto;
    }
    .det-no-desc i {
        font-size:2.4rem; color:var(--ink-3); opacity:.45;
    }
    .det-no-desc p {
        font-size:.9rem; color:var(--ink-3); margin:0; line-height:1.6;
    }
    .det-no-desc strong { color:var(--ink-2); }
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="info-panel">
                        ...
                        <!-- Stock status + Warranty badge row -->
    ...
    <div class="det-tabs">
        <div class="container">
            ...
            <div class="tab-panel active" id="tab-desc">
                ...
                <?php else: ?>
                <div class="det-no-desc">
                    <i class="fas fa-file-lines"></i>
                    <p><strong>No description available</strong><br>The seller hasn't added a description for this product yet. Check back later or contact us for more details.</p>
                </div>
                <?php endif; ?>
            </div>
