...
$page_title = 'Checkout – IT Shop.LK';
include 'header.php';
?>
    ...
    <div class="container">
        <div class="checkout-steps">
            ...
            <div class="step <?php echo !isset($_GET['step']) ? 'active' : 'completed'; ?>">
                <div class="step-dot">
                    <i class="fas fa-<?php echo isset($_GET['step']) ? 'check' : 'user'; ?>"></i>
                </div>
                <span>Details</span>
            </div>
    ...
    <div class="col-lg-6">
        <div class="pay-confirm-card fade-in">
            ...
            <div class="order-summary-mini">
                <div class="mini-line">
                    <span>Order Ref</span>
                    <strong><?php echo htmlspecialchars($ph['order_id']); ?></strong>
                </div>
                <div class="mini-line">
                    <span>Amount</span>
                    <strong>LKR <?php echo number_format((float)$ph['amount'], 2); ?></strong>
                </div>
                <div class="mini-line">
                    <span>Items</span>
                    <strong><?php echo htmlspecialchars(substr($ph['items'], 0, 60)) . (strlen($ph['items']) > 60 ? '…' : ''); ?></strong>
                </div>
            </div>
                ...
                <div class="payment-options">
                    ...
                    <label class="payment-option payhere-option">
                            ...
                            <div class="option-left">
                                ...
                                <div>
                                    <div class="option-title">
                                        PayHere <span class="recommended-tag">Recommended</span>
                                    </div>
                        ...
                        <div class="payhere-info">
                            ...
                            <p class="payhere-desc">
                                You'll be securely redirected to PayHere's payment page to complete your
                                purchase. Your card details are never shared with us.
                            </p>
                        </div>
                    </label>
                    ...
                    <label class="payment-option">
                        ...
                        <div class="option-content">
                            <div class="option-left">
                                <div class="option-icons">
                                    <i class="fas fa-university" style="color:var(--primary);font-size:1.3rem;"></i>
                                </div>
                                <div>
                        ...
                        <div class="bank-info">
                            <div class="bank-detail-row">
                                <span>Bank</span><strong>Commercial Bank of Ceylon</strong>
                            </div>
                            <div class="bank-detail-row">
                                <span>Account Name</span><strong>itshop.lk</strong>
                            </div>
                            <div class="bank-detail-row">
                                <span>Account No.</span><strong>1234567890</strong>
                            </div>
                            <div class="bank-detail-row">
                                <span>Branch</span><strong>Malabe</strong>
                            </div>
                            <p style="font-size:.78rem;color:var(--text-muted);margin:.75rem 0 0;">
                                Please use your Order ID as the payment reference. Orders are confirmed
                                after deposit verification (1–2 business days).
                            </p>
                        </div>
                    </label>
                    ...
                    <label class="payment-option">
                        ...
                        <div class="option-content">
                            <div class="option-left">
                                <div class="option-icons">
                                    <i class="fas fa-money-bill-wave" style="color:#16a34a;font-size:1.3rem;"></i>
                                </div>
                                <div>
...
.optional { color: var(--text-muted); font-weight: 400; font-size: .78rem; }
...
.field-icon-top { top: .9rem; align-self: flex-start; }
...
.payhere-option:has(input:checked) { background: linear-gradient(135deg, #f0fff0 0%, #fff 60%); }
