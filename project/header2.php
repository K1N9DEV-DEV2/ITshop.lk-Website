    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 991px) {
            ...
            .nav-search-form { width: 100%; order: 99; }
...
<nav class="navbar navbar-expand-lg fixed-top" id="mainNav">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <!-- Right group: Search → Cart → Separator → Account -->
            <div class="right-group d-flex align-items-center gap-2 ms-auto">

                <!-- ── Search bar (left of cart icon) ── -->
