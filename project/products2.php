...
try {
    ...
    foreach ($filtered_products as &$product) {
        ...
        // ── IMAGE PATH FIX ──────────────────────────────────────────────────
        // Normalise whatever is stored in the DB into a clean root-relative path.
        // Handles: absolute paths (/var/www/…), protocol URLs (http/https),
        // admin-relative paths (../uploads/…), and already-clean paths.
        ...
        if ($raw === '') {
            ...
            // Strip any leading "../" sequences and leading slashes so we always
            // get a clean root-relative path like "uploads/products/img.jpg"
...
<style>
    ...
    .pc-img img {
        ...
        /* Prevent broken-image icon from stretching the layout */
